...
export const PaymentStatusHistoryFindManySelectSchema: z.ZodType<Prisma.PaymentStatusHistorySelect> = z.object({
...
export const PaymentStatusHistoryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    paymentId: z.boolean().optional(),
    fromStatus: z.boolean().optional(),
    toStatus: z.boolean().optional(),
...
export const PaymentStatusHistoryFindManySchema: z.ZodType<Prisma.PaymentStatusHistoryFindManyArgs> = z.object({ select: PaymentStatusHistoryFindManySelectSchema.optional(), include: z.lazy(() => PaymentStatusHistoryIncludeObjectSchema.optional()), orderBy: z.union([PaymentStatusHistoryOrderByWithRelationInputObjectSchema, PaymentStatusHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: PaymentStatusHistoryWhereInputObjectSchema.optional(), cursor: PaymentStatusHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PaymentStatusHistoryScalarFieldEnumSchema, PaymentStatusHistoryScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.PaymentStatusHistoryFindManyArgs>;

export const PaymentStatusHistoryFindManyZodSchema = z.object({ select: PaymentStatusHistoryFindManySelectSchema.optional(), include: z.lazy(() => PaymentStatusHistoryIncludeObjectSchema.optional()), orderBy: z.union([PaymentStatusHistoryOrderByWithRelationInputObjectSchema, PaymentStatusHistoryOrderByWithRelationInputObjectSchema.array()]).optional(), where: PaymentStatusHistoryWhereInputObjectSchema.optional(), cursor: PaymentStatusHistoryWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([PaymentStatusHistoryScalarFieldEnumSchema, PaymentStatusHistoryScalarFieldEnumSchema.array()]).optional() }).strict();