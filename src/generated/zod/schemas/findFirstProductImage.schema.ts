...
export const ProductImageFindFirstSelectSchema: z.ZodType<Prisma.ProductImageSelect> = z.object({
...
export const ProductImageFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    productId: z.boolean().optional(),
    objectKey: z.boolean().optional(),
    altText: z.boolean().optional(),
...
export const ProductImageFindFirstSchema: z.ZodType<Prisma.ProductImageFindFirstArgs> = z.object({ select: ProductImageFindFirstSelectSchema.optional(), include: z.lazy(() => ProductImageIncludeObjectSchema.optional()), orderBy: z.union([ProductImageOrderByWithRelationInputObjectSchema, ProductImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductImageWhereInputObjectSchema.optional(), cursor: ProductImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductImageScalarFieldEnumSchema, ProductImageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductImageFindFirstArgs>;

export const ProductImageFindFirstZodSchema = z.object({ select: ProductImageFindFirstSelectSchema.optional(), include: z.lazy(() => ProductImageIncludeObjectSchema.optional()), orderBy: z.union([ProductImageOrderByWithRelationInputObjectSchema, ProductImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductImageWhereInputObjectSchema.optional(), cursor: ProductImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductImageScalarFieldEnumSchema, ProductImageScalarFieldEnumSchema.array()]).optional() }).strict();