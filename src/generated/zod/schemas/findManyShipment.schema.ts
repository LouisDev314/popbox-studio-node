...
export const ShipmentFindManySchema: z.ZodType<Prisma.ShipmentFindManyArgs> = z.object({ select: ShipmentFindManySelectSchema.optional(), include: z.lazy(() => ShipmentIncludeObjectSchema.optional()), orderBy: z.union([ShipmentOrderByWithRelationInputObjectSchema, ShipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: ShipmentWhereInputObjectSchema.optional(), cursor: ShipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShipmentScalarFieldEnumSchema, ShipmentScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ShipmentFindManyArgs>;

export const ShipmentFindManyZodSchema = z.object({ select: ShipmentFindManySelectSchema.optional(), include: z.lazy(() => ShipmentIncludeObjectSchema.optional()), orderBy: z.union([ShipmentOrderByWithRelationInputObjectSchema, ShipmentOrderByWithRelationInputObjectSchema.array()]).optional(), where: ShipmentWhereInputObjectSchema.optional(), cursor: ShipmentWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ShipmentScalarFieldEnumSchema, ShipmentScalarFieldEnumSchema.array()]).optional() }).strict();