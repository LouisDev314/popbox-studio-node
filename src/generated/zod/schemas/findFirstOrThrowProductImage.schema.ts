...
export const ProductImageFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProductImageSelect> = z.object({
...
export const ProductImageFindFirstOrThrowSchema: z.ZodType<Prisma.ProductImageFindFirstOrThrowArgs> = z.object({ select: ProductImageFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductImageIncludeObjectSchema.optional()), orderBy: z.union([ProductImageOrderByWithRelationInputObjectSchema, ProductImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductImageWhereInputObjectSchema.optional(), cursor: ProductImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductImageScalarFieldEnumSchema, ProductImageScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductImageFindFirstOrThrowArgs>;

export const ProductImageFindFirstOrThrowZodSchema = z.object({ select: ProductImageFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductImageIncludeObjectSchema.optional()), orderBy: z.union([ProductImageOrderByWithRelationInputObjectSchema, ProductImageOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductImageWhereInputObjectSchema.optional(), cursor: ProductImageWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductImageScalarFieldEnumSchema, ProductImageScalarFieldEnumSchema.array()]).optional() }).strict();