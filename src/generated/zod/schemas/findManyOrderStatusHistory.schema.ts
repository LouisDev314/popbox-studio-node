...
export const OrderStatusHistoryFindManySelectSchema: z.ZodType<Prisma.OrderStatusHistorySelect> = z.object({
...
export const OrderStatusHistoryFindManySelectZodSchema = z.object({
    id: z.boolean().optional(),
    orderId: z.boolean().optional(),
    fromStatus: z.boolean().optional(),
    toStatus: z.boolean().optional(),
