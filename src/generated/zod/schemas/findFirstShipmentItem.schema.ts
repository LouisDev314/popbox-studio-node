...
export const ShipmentItemFindFirstSelectSchema: z.ZodType<Prisma.ShipmentItemSelect> = z.object({
...
export const ShipmentItemFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    shipmentId: z.boolean().optional(),
    orderItemId: z.boolean().optional(),
    quantity: z.boolean().optional(),
