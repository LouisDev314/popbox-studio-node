...
export const OrderStatusHistoryFindFirstSelectSchema: z.ZodType<Prisma.OrderStatusHistorySelect> = z.object({
...
export const OrderStatusHistoryFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    orderId: z.boolean().optional(),
    fromStatus: z.boolean().optional(),
    toStatus: z.boolean().optional(),
