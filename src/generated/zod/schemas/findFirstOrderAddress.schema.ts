...
export const OrderAddressFindFirstSelectSchema: z.ZodType<Prisma.OrderAddressSelect> = z.object({
...
export const OrderAddressFindFirstSelectZodSchema = z.object({
    id: z.boolean().optional(),
    orderId: z.boolean().optional(),
    type: z.boolean().optional(),
    name: z.boolean().optional(),
...
export const OrderAddressFindFirstSchema: z.ZodType<Prisma.OrderAddressFindFirstArgs> = z.object({ select: OrderAddressFindFirstSelectSchema.optional(), include: z.lazy(() => OrderAddressIncludeObjectSchema.optional()), orderBy: z.union([OrderAddressOrderByWithRelationInputObjectSchema, OrderAddressOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrderAddressWhereInputObjectSchema.optional(), cursor: OrderAddressWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrderAddressScalarFieldEnumSchema, OrderAddressScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.OrderAddressFindFirstArgs>;

export const OrderAddressFindFirstZodSchema = z.object({ select: OrderAddressFindFirstSelectSchema.optional(), include: z.lazy(() => OrderAddressIncludeObjectSchema.optional()), orderBy: z.union([OrderAddressOrderByWithRelationInputObjectSchema, OrderAddressOrderByWithRelationInputObjectSchema.array()]).optional(), where: OrderAddressWhereInputObjectSchema.optional(), cursor: OrderAddressWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([OrderAddressScalarFieldEnumSchema, OrderAddressScalarFieldEnumSchema.array()]).optional() }).strict();