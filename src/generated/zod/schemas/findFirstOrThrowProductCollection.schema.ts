...
export const ProductCollectionFindFirstOrThrowSelectSchema: z.ZodType<Prisma.ProductCollectionSelect> = z.object({
...
export const ProductCollectionFindFirstOrThrowSelectZodSchema = z.object({
    productId: z.boolean().optional(),
    collectionId: z.boolean().optional(),
    sortOrder: z.boolean().optional(),
    product: z.boolean().optional(),
...
export const ProductCollectionFindFirstOrThrowSchema: z.ZodType<Prisma.ProductCollectionFindFirstOrThrowArgs> = z.object({ select: ProductCollectionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductCollectionIncludeObjectSchema.optional()), orderBy: z.union([ProductCollectionOrderByWithRelationInputObjectSchema, ProductCollectionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductCollectionWhereInputObjectSchema.optional(), cursor: ProductCollectionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductCollectionScalarFieldEnumSchema, ProductCollectionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductCollectionFindFirstOrThrowArgs>;

export const ProductCollectionFindFirstOrThrowZodSchema = z.object({ select: ProductCollectionFindFirstOrThrowSelectSchema.optional(), include: z.lazy(() => ProductCollectionIncludeObjectSchema.optional()), orderBy: z.union([ProductCollectionOrderByWithRelationInputObjectSchema, ProductCollectionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductCollectionWhereInputObjectSchema.optional(), cursor: ProductCollectionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductCollectionScalarFieldEnumSchema, ProductCollectionScalarFieldEnumSchema.array()]).optional() }).strict();