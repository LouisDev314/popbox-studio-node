...
import { PaymentUpdateOneRequiredWithoutStatusHistoryNestedInputObjectSchema as PaymentUpdateOneRequiredWithoutStatusHistoryNestedInputObjectSchema } from './PaymentUpdateOneRequiredWithoutStatusHistoryNestedInput.schema'
...
const makeSchema = () => z.object({
  ...
  payment: z.lazy(() => PaymentUpdateOneRequiredWithoutStatusHistoryNestedInputObjectSchema).optional()
}).strict();
export const PaymentStatusHistoryUpdateInputObjectSchema: z.ZodType<Prisma.PaymentStatusHistoryUpdateInput> = makeSchema() as unknown as z.ZodType<Prisma.PaymentStatusHistoryUpdateInput>;
export const PaymentStatusHistoryUpdateInputObjectZodSchema = makeSchema();
