...
export const ProductCollectionFindFirstSelectSchema: z.ZodType<Prisma.ProductCollectionSelect> = z.object({
...
export const ProductCollectionFindFirstSelectZodSchema = z.object({
    productId: z.boolean().optional(),
    collectionId: z.boolean().optional(),
    sortOrder: z.boolean().optional(),
    product: z.boolean().optional(),
...
export const ProductCollectionFindFirstSchema: z.ZodType<Prisma.ProductCollectionFindFirstArgs> = z.object({ select: ProductCollectionFindFirstSelectSchema.optional(), include: z.lazy(() => ProductCollectionIncludeObjectSchema.optional()), orderBy: z.union([ProductCollectionOrderByWithRelationInputObjectSchema, ProductCollectionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductCollectionWhereInputObjectSchema.optional(), cursor: ProductCollectionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductCollectionScalarFieldEnumSchema, ProductCollectionScalarFieldEnumSchema.array()]).optional() }).strict() as unknown as z.ZodType<Prisma.ProductCollectionFindFirstArgs>;

export const ProductCollectionFindFirstZodSchema = z.object({ select: ProductCollectionFindFirstSelectSchema.optional(), include: z.lazy(() => ProductCollectionIncludeObjectSchema.optional()), orderBy: z.union([ProductCollectionOrderByWithRelationInputObjectSchema, ProductCollectionOrderByWithRelationInputObjectSchema.array()]).optional(), where: ProductCollectionWhereInputObjectSchema.optional(), cursor: ProductCollectionWhereUniqueInputObjectSchema.optional(), take: z.number().optional(), skip: z.number().optional(), distinct: z.union([ProductCollectionScalarFieldEnumSchema, ProductCollectionScalarFieldEnumSchema.array()]).optional() }).strict();